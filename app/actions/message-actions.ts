...
export async function sendMessage(conversationId: number, userId: number, formData: FormData) {
  try {
...
export async function getMessagesForConversation(conversationId: number, limit = 50, offset = 0) {
  try {
    const messages = await sql`
