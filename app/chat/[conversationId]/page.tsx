...
export default async function ConversationPage({
  ...
  return (
    <div className="flex h-screen bg-gray-950">
      <div className="hidden md:block w-80">{/* Sidebar will be included in the layout */}</div>
      <div className="flex-1">
        <ConversationView conversationId={conversationId} userId={user.id} initialConversation={result.conversation} />
      </div>
    </div>
  )
}
