  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-950 p-4">
      <div className="text-center max-w-md">
        ...
        <div className={cn("p-4 rounded-lg", "bg-gray-900/50 border border-gray-800", "text-sm text-gray-400")}>
          <p className="mb-2">
            <span className="text-[#ff00ff] font-medium">Tip:</span> Use the "New Conversation" button to start chatting
            with other users.
          </p>
        </div>
      </div>
