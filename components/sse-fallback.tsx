    ...
    <div className="flex flex-col items-center justify-center h-full p-4">
      ...
      >
        ...
        <p className="text-gray-400 mb-4">
          We&apos;re having trouble establishing a real-time connection. This
          could be due to network issues or server load.
        </p>
        <p className="text-gray-400 mb-4">
          Retrying in{" "}
          <span className="text-[#00ffff] font-bold">{countdown}</span>{" "}
          seconds...
        </p>
        <button
          onClick={onRetry}
